        ...
        fun bind(post: News) {
            ...
            likeBtn.setOnClickListener(){
                if (itemClickListener!=null) {
                    if (post.liked == 1) {
                        FavoritesFragment.favoriteList.remove(post) //remove news from favorite list
                        post.liked = 0
                        ...
                        if (!FavoritesFragment.favoriteList.contains(post)) {
                            FavoritesFragment.favoriteList.add(post) //add news to favorite list
                        }
                        post.liked = 1
                        post.likeNum = post.likeNum + 1
